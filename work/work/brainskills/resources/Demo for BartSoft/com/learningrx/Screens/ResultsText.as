package com.learningrx.Screens
{
	...
	public class ResultsText extends Sprite
	{
		...
		public function ResultsText(pParent:Framework)
		{
			_Parent = pParent;
			DrawBorder();
		...
		public function set PercentageCorrect(pPercentageCorrect:Number)
		{
			if (pPercentageCorrect > 90)
			{
				_Body.text = 'Congratulations! You '
			}
			else
			{
				_Body.text = 'You '
			}
			_Body.appendText('got ' + Math.round(pPercentageCorrect) + '% correct.');
		}

		private function CreateTextFields():void
		{
			CreateTextField(_Head, 'Arial Rounded MT Bold', 36, 0xFFFFFF, 100, 100);
			CreateTextField(_Subhead, 'Arial Rounded MT Bold', 24, 0x0066FF, 100, 150);
			CreateTextField(_Body, 'Arial', 24, 0xFFFFFF, 100, 300);
		}
